...
results_dir = os.path.join(BASE_DIR, "medgemma_4b")
...
jsonl_files = glob.glob(os.path.join(results_dir, "*_avaliacoes.jsonl"))
...
pipeline_name_to_key = {
    ...
    "graph_rag": "05_graph",
    "guarded_hybrid_agentic_fusion_rag": "07_guarded"
}
