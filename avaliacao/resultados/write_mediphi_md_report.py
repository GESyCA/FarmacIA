...
json_path = os.path.join(BASE_DIR, "mediphi", "mediphi_compiled_results.json")
local_artifact_path = os.path.join(BASE_DIR, "mediphi_comparison.md")
...
if brain_dir:
    brain_artifact_path = os.path.join(brain_dir, "mediphi_comparison.md")
else:
    brain_artifact_path = r"C:\Users\silvi\.gemini\antigravity-ide\brain\05ce8a65-516e-47e2-9e7e-235ac724cc0e\mediphi_comparison.md"
...
md = []
md.append("# Comparação Intramodelo - MediPhi Instruct (ollama:mediphi-instruct)")
md.append("")
md.append("Este relatório compara de forma objetiva o impacto do **nível de dificuldade das perguntas** e do **pipeline de RAG** na recuperação e na geração de respostas, além de reportar os tempos médios de execução obtidos com o modelo **MediPhi Instruct**.")
md.append("")
md.append("> [!NOTE]")
...
print("MediPhi Markdown report successfully generated!")
