...
results_dir = os.path.join(BASE_DIR, "phi4-mini")
...
# Save compiled JSON
output_json_path = os.path.join(results_dir, "phi4_compiled_results.json")
...
print("Phi4 compilation successful! Summary saved to JSON.")
