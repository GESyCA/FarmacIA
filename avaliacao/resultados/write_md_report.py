...
json_path = os.path.join(BASE_DIR, "gemma_4_4b", "gemma_compiled_results.json")
artifact_path = os.path.join(BASE_DIR, "gemma_4b_comparison_temp.md")
...
if brain_dir:
    brain_path = os.path.join(brain_dir, "gemma_4b_comparison.md")
else:
    brain_path = r"C:\Users\silvi\.gemini\antigravity-ide\brain\1a3c785a-6072-4558-9ec6-db9b3d651509\gemma_4b_comparison.md"
...
md.append("")
md.append("Este relatório compara de forma objetiva o impacto do **nível de dificuldade das perguntas** e do **pipeline de RAG** na recuperação e na geração de respostas, além de reportar os tempos médios de execução obtidos com o modelo **Gemma 4:4b**.")
md.append("")
md.append("> [!NOTE]")
