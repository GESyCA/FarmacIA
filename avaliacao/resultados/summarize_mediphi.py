...
results_dir = os.path.join(BASE_DIR, "mediphi")
...
# Save compiled JSON
output_json_path = os.path.join(results_dir, "mediphi_compiled_results.json")
...
print("MediPhi compilation successful! Summary saved to JSON.")
